...
java -jar ./ANTLR/antlr4-4.7.2-complete.jar -visitor ./src/main/scala/org/apache/spark/sql/catalyst/parser/SqlBase.g4
#java -jar /home/larissacsh/Documents/entityResolution/gcore-spark/ANTLR/antlr4-4.7.2-complete.jar -visitor /home/larissacsh/Documents/entityResolution/gcore-spark/src/main/scala/org/apache/spark/sql/catalyst/parser/SqlBase.g4
