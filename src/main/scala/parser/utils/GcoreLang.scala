...
object GcoreLang {
  ...
  val GCORE_GRAMMAR_SPEC: String = "gcore-spoofax-0.1.0-SNAPSHOTModified.spoofax-language"
  //val GCORE_GRAMMAR_SPEC: String = "gcore-spoofax-0.1.0-SNAPSHOTModifiedLimit.spoofax-language"
//  val GCORE_GRAMMAR_SPEC: String = "gcore-spoofax-0.1.0-SNAPSHOTNEW.spoofax-language"
