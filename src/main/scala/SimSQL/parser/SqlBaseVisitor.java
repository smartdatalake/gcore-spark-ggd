...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#simExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSimExpression(SqlBaseParser.SimExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#simFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSimFunction(SqlBaseParser.SimFunctionContext ctx);
	/**
