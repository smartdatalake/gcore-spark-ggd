...
private object SparkSqlSerializer {
...
private class JavaBigDecimalSerializer extends Serializer[java.math.BigDecimal] {
...
private class ScalaBigDecimalSerializer extends Serializer[BigDecimal] {
