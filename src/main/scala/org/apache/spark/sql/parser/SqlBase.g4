 ...
 */
 ...
 /*
 Modified grammar from Sparks original project to include SimilarityJoin operations on SparkSQL
 */
...
joinCriteria
    ...
    | USING ('(' identifier (',' identifier)* ')'| simExpression)
    ;
...
simExpression
    : simFunction '(' primaryExpression ',' primaryExpression ')' comparisonOperator number
    ;
...
identifier
    : strictIdentifier
    | ANTI | FULL | INNER | LEFT | SEMI | RIGHT | NATURAL | JOIN | CROSS | ON | SIMILARITY
